...
private:
	...
	static void onPOVChange(__int64 a1, unsigned int pov);
	...
	std::unique_ptr<FuncHook> onPOVChangeHook;
...
public:
	...
	void enableHook(bool enable = true) {
		if (funcPtr != nullptr) {
			...
			("enableHook() called with nullptr func!");
	}
