...
public:
	...
	virtual __int64 sendToClient(__int64 UserEntityIdentifierComponent, C_Packet* const&);
	virtual __int64 sendToClient(const void* networkIdentifier, const C_Packet* packet, int a4);
	virtual __int64 sendToClients(const void* networkIdentifier, const C_Packet* packet);
